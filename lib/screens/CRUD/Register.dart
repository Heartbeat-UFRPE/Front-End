  ...
  void OnRegisterClick() {
    ...
    if (_checkMasculino == true) {
      ...
      if (senhaUser != confsenhaUser) {
        AlertSnackBar("A confirmação de senha deve ser igual a senha",
            _controlConfirmSenha, true);
        return;
      }

      if (_checkedtermos == false) {
        AlertSnackBar(
            "Por favor aceite os termos de Uso", _controlConfirmSenha, false);
        return;
      }
    ...
    void AlertSnackBar(String alert, TextEditingController control,
        bool check) {
